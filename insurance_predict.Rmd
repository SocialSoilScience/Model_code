...
insurance <- read.csv("./data-raw/insurance.csv",
...
使用predict()函数将dmy应用于insurance_learning数据集，得到哑变量；
使用cbind()函数将这些哑变量加入insurance_learning数据集；
删除原始的定类变量sex,smoker和region；
